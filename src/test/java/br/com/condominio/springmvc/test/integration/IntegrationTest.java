package br.com.condominio.springmvc.test.integration;
...
public class IntegrationTest {
    ...
    private static final String BASE_URL = "http://localhost:8080/condominio/";
    ...
    public void beforeTestCase() {
        ...
        template = new BasicAuthRestTemplate("admin", "123");
    }
