...
import br.com.condominio.springmvc.exception.InvalidRequestException;
import br.com.condominio.springmvc.model.CommentDetails;
import br.com.condominio.springmvc.model.CommentForm;
...
public class PostController {
    ...
    @ResponseBody
    public ResponseEntity<ResponseMessage> createCommentOfPost( @PathVariable("id") Long id, @RequestBody CommentForm comment) {
